...
window.addEventListener("DOMContentLoaded", () => {
 ...
 const translations = {
  en: {
    ...
    project2Title: "Data Analysis Portfolio",
    project2Desc: "Showcasing my data projects with insights and visualizations as well as cleaning.",
  ...
  ar: {
    ...
    project2Title: "مشاريع تحليل البيانات",
    project2Desc: "موقع شخصي لعرض اخر مشاريعي في تحليل وعرض البيانات",
